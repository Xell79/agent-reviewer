...
PRINCIPLES
- Judge what the command DOES, not the leading word. Wrappers (find -exec, xargs, base64|sh, $()) count.
...
- runs arbitrary inline code (python -c, python -e, node -e, ruby -e, perl -e, bash -c with non-trivial payload)
